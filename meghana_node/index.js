...
const getMusicData = async (client) => {
    //Fetches records from given database
    const cursor = await client.db("MusicDB").collection("Songs").find({});
...
const server = http.createServer(async (req, res) => {
    ...
    if (req.url === "/api") {
        const URL = "mongodb+srv://meghana:Meghoney%403@cluster0.atkthl6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
        ...
        try {
            ...
            const musicData = await getMusicData(client);
